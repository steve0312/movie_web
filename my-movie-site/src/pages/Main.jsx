...
//       <div>
//         <h2>현재 상영 중인 영화</h2>
//         <Link to="/movie/nowPlaying" className="underLineNone textWhite">
//           더보기
//         </Link>
...
//         {/* 인기있는 영화를 일부만 보여줌 */}
//         <h2>인기있는 영화</h2>
//         <Link to="/movie/popular" className="underLineNone textWhite">
//           더보기
//         </Link>
...
//         {/* 최고 평점 영화를 일부만 보여줌 */}
//         <h2>최고 평점 영화</h2>
//         <Link to="/movie/topRated" className="underLineNone textWhite">
//           더보기
//         </Link>
